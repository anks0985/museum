...
const MuseumCatalogueExplorer = () => {
  ...
  return (
    <div className="bg-[#fffdf8] font-['Nunito_Sans'] text-[#212121] overflow-x-hidden min-h-screen">
      {/* Header */}
        ...
        <div className="max-w-7xl mx-auto px-10">
          <div className="flex justify-between items-center md:flex-row flex-col md:gap-0 gap-5">
            <a href="#" className="text-[#212121] no-underline flex flex-col">
              <div className="font-['Cormorant_Garamond'] font-medium text-2xl tracking-wider">THE MUSEUM</div>
              <div className="font-['Cormorant_Garamond'] font-normal text-sm opacity-70 mt-0.5">THE SILENT HERITAGE</div>
            </a>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-10">
          ...
          {/* Page Heading */}
          <div className="mb-16">
            <h1 className="font-['Cormorant_Garamond'] font-medium text-4xl mb-2.5">Catalogue Explorer</h1>
          ...
          <div className="flex justify-between items-center mb-8">
            <h2 className="font-['Cormorant_Garamond'] font-medium text-3xl relative pl-4 before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-1 before:h-6 before:bg-[#d1bc8a]">Select Brand</h2>
          </div>
            ...
            {brands.map((brand, index) => (
              ...
              >
                ...
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#00000066] to-[#00000033] flex items-center justify-center text-white transition-all duration-400 ease-out">
                  <h3 className="font-['Cormorant_Garamond'] font-medium text-2xl text-center px-5 drop-shadow-md">{brand.name}</h3>
                </div>
              </div>
            ))}
          </div>
          ...
          {/* Artist Selection */}
          <div className="flex justify-between items-center mb-8">
            <h2 className="font-['Cormorant_Garamond'] font-medium text-3xl relative pl-4 before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-1 before:h-6 before:bg-[#d1bc8a]">Japanese Master Artists</h2>
            ...
            {artists.map((artist, index) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 bg-gradient-to-t from-[#000000b3] to-transparent text-white transition-all duration-400 ease-out">
                  <h3 className="font-['Cormorant_Garamond'] font-medium text-2xl mb-2">{artist.name}</h3>
          ...
          <div className="flex justify-between items-center mb-8">
            <h2 className="font-['Cormorant_Garamond'] font-medium text-3xl relative pl-4 before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-1 before:h-6 before:bg-[#d1bc8a]">
            ...
            {artworks.map((artwork, index) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 w-full p-8 bg-gradient-to-t from-[#000000b3] to-transparent text-white transition-all duration-400 ease-out">
                  <h3 className="font-['Cormorant_Garamond'] font-medium text-2xl mb-2.5">{artwork.title}</h3>
